...
echo "[sandbox/python-conda/gate] WARNING: The python-conda profile has no default gate."
echo "[sandbox/python-conda/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/python-conda/gate] Gate PASSED."
