...
echo "[sandbox/python-uv/gate] WARNING: The python-uv profile has no default gate."
echo "[sandbox/python-uv/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/python-uv/gate] Gate PASSED."
