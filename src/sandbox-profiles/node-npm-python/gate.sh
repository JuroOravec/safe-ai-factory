...
echo "[sandbox/node-npm-python/gate] WARNING: The node-npm-python profile has no default gate."
echo "[sandbox/node-npm-python/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/node-npm-python/gate] Gate PASSED."
