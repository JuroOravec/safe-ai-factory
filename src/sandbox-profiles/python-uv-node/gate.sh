...
echo "[sandbox/python-uv-node/gate] WARNING: The python-uv-node profile has no default gate."
echo "[sandbox/python-uv-node/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/python-uv-node/gate] Gate PASSED."
