...
echo "[sandbox/python-pip-node/gate] WARNING: The python-pip-node profile has no default gate."
echo "[sandbox/python-pip-node/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/python-pip-node/gate] Gate PASSED."
