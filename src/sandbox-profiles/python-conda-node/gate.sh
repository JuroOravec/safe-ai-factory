...
echo "[sandbox/python-conda-node/gate] WARNING: The python-conda-node profile has no default gate."
echo "[sandbox/python-conda-node/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/python-conda-node/gate] Gate PASSED."
