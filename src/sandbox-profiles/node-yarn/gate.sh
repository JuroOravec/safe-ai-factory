...
echo "[sandbox/node-yarn/gate] WARNING: The node-yarn profile has no default gate."
echo "[sandbox/node-yarn/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/node-yarn/gate] Gate PASSED."
