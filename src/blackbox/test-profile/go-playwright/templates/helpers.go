// Package helpers provides black-box test helpers for the Software Factory test runner.
// Auto-generated by `agents feat:design`. Do not edit; regenerate with `agents feat:design <changeName>`.
package helpers
