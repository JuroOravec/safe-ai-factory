...
echo "[sandbox/python-pip/gate] WARNING: The python-pip profile has no default gate."
echo "[sandbox/python-pip/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/python-pip/gate] Gate PASSED."
