...
echo "[sandbox/node-yarn-python/gate] WARNING: The node-yarn-python profile has no default gate."
echo "[sandbox/node-yarn-python/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/node-yarn-python/gate] Gate PASSED."
