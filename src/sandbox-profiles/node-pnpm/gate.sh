...
echo "[sandbox/node-pnpm/gate] WARNING: The node-pnpm profile has no default gate."
echo "[sandbox/node-pnpm/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/node-pnpm/gate] Gate PASSED."
