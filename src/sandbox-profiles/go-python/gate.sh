...
echo "[sandbox/go-python/gate] WARNING: Running DEFAULT gate (go vet + go test)."
echo "[sandbox/go-python/gate] Define a custom --gate-script with more checks for better results."

echo "[sandbox/go-python/gate] Running go vet..."
go vet ./...
echo "[sandbox/go-python/gate] Running go test..."
go test ./...
echo "[sandbox/go-python/gate] Gate PASSED."
