...
echo "[sandbox/node-pnpm-python/gate] WARNING: The node-pnpm-python profile has no default gate."
echo "[sandbox/node-pnpm-python/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/node-pnpm-python/gate] Gate PASSED."
