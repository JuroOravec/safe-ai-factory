...
echo "[sandbox/node-npm/gate] WARNING: The node-npm profile has no default gate."
echo "[sandbox/node-npm/gate] Define a custom --gate-script with more checks for better results."
echo "[sandbox/node-npm/gate] Gate PASSED."
